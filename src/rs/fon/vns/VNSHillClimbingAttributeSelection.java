...
public class VNSHillClimbingAttributeSelection extends OperatorChain {
	...
	// Constructor
	public VNSHillClimbingAttributeSelection(OperatorDescription description)
			...
			case 1: // Default iterated
				for (int i1 = 0; i1 < no_of_iteration; i1++) {
					...
					for (int j = 0; j < no_of_iterations2; j++) {
						...
						if (z2 == 0) {
							w2[RandomGenerator.getRandomGenerator(this)
							   .nextInt(w2.length)] = 1;
						}
