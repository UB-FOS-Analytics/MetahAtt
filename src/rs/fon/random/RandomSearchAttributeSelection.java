...
public class RandomSearchAttributeSelection extends OperatorChain {
	...
	// Constructor
	public RandomSearchAttributeSelection(OperatorDescription description)
	...
	public void doWork() throws OperatorException {
		...
		for (int i = 0; i < iterations; i++) {
			...
			int zeroes = exampleSet.getAttributes().size();
			...
			if (zeroes == 0) {
				int element = RandomGenerator.getRandomGenerator(this).nextInt(
